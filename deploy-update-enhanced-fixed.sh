...
# Enhanced git update function with better handling
update_from_git() {
    ...
    # Check if there are any local changes that might conflict
    if ! git diff --quiet HEAD origin/main; then
        print_info "Remote changes detected, updating..."
        
        # Use reset instead of pull for cleaner update
        print_info "Performing hard reset to origin/main..."
...
main() {
    ...
    # Step 5: Update from git (IMPROVED)
